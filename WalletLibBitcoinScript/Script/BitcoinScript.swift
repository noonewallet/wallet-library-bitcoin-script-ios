...
public class BitcoinScript {
    ...
    public convenience init(address: BitcoinScriptAddressProtocol) {
    
        self.init()
        
        switch address.scriptHashType {
        case .P2PKH:
    ...
    /// - Parameter address: Object BitcoinPublicKeyAddress
    public func addScript(from address: BitcoinScriptAddressProtocol) {
    ...
    public func getPublicKeyHash() throws -> Data {
        ...
        case .none:
            ...
            throw BitcoinScriptError.invalidScriptHashType
